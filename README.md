...
<h6 align="center"> 
	Se você quiser visualizar a aplicação, clique <a href="https://rocket-coffee-ls.netlify.app/">aqui</a>.
</h6>

<h3 id="sobre">:information_source: Sobre</h3>

> Este projeto foi desenvolvido utilizando HTML5, CSS. 

A ideia é:

_"Criar um projeto simples relacionado a um cardápio de tipos de café."_
...
Este projeto está licenciado sob a Licença MIT License - veja o [LICENSE.md](https://github.com/LucasSantus/rocket-coffee/blob/master/LICENSE) para melhores detalhes.
